...
<section class="section">
    <div class="card">
        <div class="card-body">
            <h5 class="card-title mt-3">Form Tambah Area Parkir</h5>
            ...
            <form action="{{ route('admin.parking-areas.store') }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <small class="text-muted">Masukkan nama unik yang membedakan antar area parkir.</small>
                        @error('name')
                    ...
                    <div class="col-md-6">
                        ...
                        <small class="text-muted">Opsional — isi lokasi fisik area parkir agar mudah diidentifikasi.</small>
                        @error('location')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
