        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control"
                            value="{{ $record->ticket_code }}" disabled>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control"
                            value="{{ $record->parkingSlot->slot_code ?? $record->parkingSlot->id ?? '-' }}"
                            disabled>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control"
                            value="Rp {{ number_format($record->tarif->rate ?? 0, 0, ',', '.') }}"
                            disabled>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control"
                            value="{{ \Carbon\Carbon::parse($record->entry_time)->format('d/m/Y H:i') }}"
                            disabled>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control"
                            value="{{ $record->exit_time
                                ? \Carbon\Carbon::parse($record->exit_time)->format('d/m/Y H:i')
                                : '-' }}"
                            disabled>
                    </div>
                    ...
                    @php
                        ...
                        $exit = $record->exit_time
                            ? \Carbon\Carbon::parse($record->exit_time)
                            : now();
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control"
                            value="{{ $duration->days * 24 + $duration->h }} jam {{ $duration->i }} mnt"
                            disabled>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control"
                            value="{{ $record->payment_status === 'paid'
                                ? 'Pembayaran Selesai'
                                : 'Menunggu Pembayaran' }}"
                            disabled>
                    </div>
                ...
                <div class="mt-4 d-flex gap-2">
                    ...
                    <form action="{{ route('admin.parking-records.destroy', $record->id) }}"
                        method="POST"
