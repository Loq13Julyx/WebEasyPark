                    ...
                    <tbody>
                        @forelse ($records as $index => $record)
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($record->status === 'in')
                                        <form action="{{ route('officer.parking-exit.process', $record->id) }}" method="POST" class="d-inline exit-form">
                                            @csrf
                        ...
                        @empty
                            <tr>
                                <td colspan="8" class="text-center text-muted">Tidak ada kendaraan yang sedang parkir.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
